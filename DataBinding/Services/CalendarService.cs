    ...
    public class CalendarService : ICalendarService
    {
        public Task<IEnumerable<CalendarEntry>> GetEntriesAsync(DateOnly date)
        {
            ...
            return Task.FromResult(new List<CalendarEntry>
            {
                ...
                {
                    Name = "Meeting 1",
                    Start = new DateTimeOffset(new DateTime(2022, 3, 4, 10, 0, 0)),
                    Duration = TimeSpan.FromMinutes(45)
                },
                new CalendarEntry
                {
                    Name = "Meeting 2",
                    Start = new DateTimeOffset(new DateTime(2022, 3, 14, 13, 10, 0)),
                    Duration = TimeSpan.FromMinutes(45)
                },
                new CalendarEntry
                {
                    Name = "Meeting 3",
                    Start = new DateTimeOffset(new DateTime(2022, 3, 14, 10, 0, 0)),
                    Duration = TimeSpan.FromMinutes(45)
                },
                new CalendarEntry
                {
                    Name = "Meeting 4",
                    Start = new DateTimeOffset(new DateTime(2022, 3, 14, 11, 15, 0)),
                    Duration = TimeSpan.FromMinutes(45)
                },
                new CalendarEntry
                {
                    Name = "Meeting 5",
                    Start = new DateTimeOffset(new DateTime(2022, 3, 21, 11, 15, 0)),
                    Duration = TimeSpan.FromMinutes(45)
                },
                new CalendarEntry
                {
